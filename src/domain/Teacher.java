...
public class Teacher implements java.io.Serializable {
	...
	/** minimal constructor */
	public Teacher(String teaName, String teaSex, String teaPassword) {
	...
	/** full constructor */
	public Teacher(String teaNo, String teaName, String teaSex, String teaPhone, String teaPassword, Set startClasses) {
		this.teaNo = teaNo;
		this.teaName = teaName;
		this.teaSex = teaSex;
