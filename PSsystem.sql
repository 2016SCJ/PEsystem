...
create table StartClass(               --开课班
	...
	claCapacity int,             --开课班容量
	claRemain int,               --开课班剩余容量
...
insert into StartClass values(1, 4, '35栋楼下', '第1-16周星期三第3-4节', 50, 50)
insert into StartClass values(2, 1, '轮滑场', '第1-16周星期三第3-4节', 50, 50)
insert into StartClass values(3, 3, '休闲健身教室（体育部游泳池一层）', '第1-16周星期三第3-4节', 50, 50)
insert into StartClass values(4, 2, '网球场', '第1-16周星期三第3-4节', 50, 50)
insert into StartClass values(5, 5, '篮球场', '第1-16周星期三第3-4节', 50, 50)
