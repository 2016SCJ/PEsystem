...
public class AdminDaoBean implements AdminDao {
	...
	@Override
	public List<Profession> admin_addStuInit() {
		String queryString ="from Profession";
		List<Profession> allProfession = null;
		allProfession = sessionFactory.getCurrentSession().createQuery(queryString).list();
	...
	@Override
	public boolean admin_addStartClass(Integer couId, Integer teaId, String claLocation, String claTime, Integer addNum) {
		...
		startClass.setClaCapacity(addNum);
		startClass.setClaRemain(addNum);
